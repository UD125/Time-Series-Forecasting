...
Path<-"E:/R/Time-Series-Forecasting"
setwd(Path)
getwd()
...
plot(diff(TSdata),ylab="diff(Sales)",xlab="Year",main="diff(Sales) between 2003-2014",col="grey") #default is 1 for differencing

##Differencing the data to remove trend 
plot(diff(TSdata,differences = 1),ylab="Diff(Sales)",xlab="Year",main="Diff(Sales) between 2003-2014",col="grey") #same as above 
